...
system by putting the "project" on gitlab. As a nice side-effect, this
"hack" also allows to have local packages in editable mode, i.e. changes
I make locally are immediately reflected in the playground, I don't have
to publish them first etc.
